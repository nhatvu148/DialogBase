...
CComboboxListboxDlg::CComboboxListboxDlg(CWnd* pParent /*=nullptr*/)
...
// CComboboxListboxDlg message handlers

BOOL CComboboxListboxDlg::OnInitDialog()
{
...
void CComboboxListboxDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CComboboxListboxDlg::OnPaint()
{
	if (IsIconic())
	{
...
HCURSOR CComboboxListboxDlg::OnQueryDragIcon()
{
